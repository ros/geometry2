...
## A sample python unit test (multi channel version)
class PointCloudConversions(unittest.TestCase):
    def setUp(self):
        ...
        points = [1, 2, 0, 123, 10, 20, 30, 456]
        self.point_cloud_in.data = struct.pack('3fi3fi', *points)
        ...
        assert(list(point_cloud2.read_points(self.point_cloud_in)) == [(1.0, 2.0, 0.0, 123), (10.0, 20.0, 30.0, 456)])
    ...
    def test_simple_transform(self):
        ...
        k = 300
        expected_coordinates = [(1+k, 2+k, 0+k, 123), (10+k, 20+k, 30+k, 456)]
...
if __name__ == '__main__':
    import rosunit
    rosunit.unitrun("test_tf2_sensor_msgs", "test_point_cloud_conversion_multichannel", PointCloudConversionsMultichannel)
